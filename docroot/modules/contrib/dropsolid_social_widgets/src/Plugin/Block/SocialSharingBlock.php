...
namespace Drupal\dropsolid_social_widgets\Plugin\Block;

use Drupal\Core\Block\BlockBase;
use Drupal\Core\Form\FormStateInterface;
use Drupal\Core\Plugin\ContainerFactoryPluginInterface;
use Drupal\dropsolid_social_widgets\SocialShareLinkManager;
 ...
 *
 * @Block(
 *   id = "dropsolid_social_widgets_block",
 *   admin_label = @Translation("Dropsolid social widgets"),
...
class SocialSharingBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * @var \Drupal\dropsolid_social_widgets\SocialShareLinkManager
   */
   ...
   * @param \Drupal\dropsolid_social_widgets\SocialShareLinkManager $socialShareLinksManager
...
   .*/
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $container->get('dropsolid_social_widgets.manager')
    );
  }
  ...
  public function build() {
    ...
    // Create the build
    $build = dropsolid_social_widgets_build_links($this->socialShareLinksManager->getSocialShareLinks(), $enabled_links);
