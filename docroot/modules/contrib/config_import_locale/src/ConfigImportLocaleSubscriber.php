 ...
 * The only function that is overwritten is updateLocaleStorage, to make sure it respects the overwrite_interface_translation
...
class ConfigImportLocaleSubscriber extends LocaleConfigSubscriber {
  ...
  /**
   * Updates an interface translation, but only if no previous translation is set
   *
