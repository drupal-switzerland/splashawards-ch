...
pushd docroot/core
../../vendor/bin/phpunit --testsuite=functional --printer="\Drupal\Tests\Listeners\HtmlOutputPrinter" --log-junit="/builds/hostingplatform/skeletons-skeleton8/artifacts/junit-report.xml"
TEST_STATUS=$?
popd
